...
def register_model():
    ...
    ModelRegistry.register_model(
        ...
        "vllm_mblt.models.modeling_llama:MobilintLlamaForCausalLM"
    )

    ModelRegistry.register_model(
        "MobilintExaoneForCausalLM",
        "vllm_mblt.models.modeling_exaone:MobilintExaoneForCausalLM"
    )

    ModelRegistry.register_model(
        "MobilintExaone4ForCausalLM",
        "vllm_mblt.models.modeling_exaone4:MobilintExaone4ForCausalLM"
    )

    ModelRegistry.register_model(
        "MobilintQwen2ForCausalLM",
        "vllm_mblt.models.modeling_qwen2:MobilintQwen2ForCausalLM"
    )

    ModelRegistry.register_model(
        "MobilintQwen3ForCausalLM",
        "vllm_mblt.models.modeling_qwen3:MobilintQwen3ForCausalLM"
    )
